...
我曾被无数次的拷问：教程是Python 2还是Python 3？我非常想告诉他什么都支持，但是，我的代码的确是在Python 2下调试的，总不能撒谎吧。于是当我如实奉告的时候，他会说要学习Python 3，于是转头找那些号称是Python 3的教程，虽然他也不知道里面的代码是否真的在Python 3下调试，只看看标题罢了。
